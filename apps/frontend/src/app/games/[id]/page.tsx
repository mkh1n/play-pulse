...
export default function GameDetailPage() {
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <button onClick={() => router.back()} className={styles.backButton}>
            <img src="../icons/arrow.svg" className={styles.backButtonArrow} />
            Назад
          </button>
        </div>
  ...
  return (
    <>
        <title>{game ? `PlayPulse | ${game.name}` : "PlayPulse | Загрузка..."}</title>
      <div className={styles.container}>
              ...
              <div className={styles.heroMain}>
                <div className={styles.heroText}>
                  ...
                  <div className={styles.gameMeta}>
                    {game.released && (
                      <span className={styles.metaItem} id={styles.releasedTag} title="Год выхода">
                        {formatDate(game.released)}
                      </span>
                    )}
                    {game.developers?.[0] && (
                      <span className={styles.metaItem} id={styles.developerTag} title="Разработчик">
                        {game.developers[0].name}
                      </span>
                    )}
                    {game.genres?.[0] && (
                      <span className={styles.metaItem} id={styles.genreTag} title="Жанр">
                        {game.genres[0].name}
                      </span>
                    )}
                  </div>
                ...
                <div className={styles.heroActionsLeft}>
                  {averagePrice !== null && (
                    ...
                    >
                      ...
                      <img src="../icons/arrow.svg" className={styles.priceArrow} />
                    </button>
                  )}
